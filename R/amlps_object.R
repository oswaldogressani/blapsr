...
#'
#' An object returned by the \code{\link{amlps}} function consists in a list
#' with various components related to the fit of an additive partial linear
#' model with the Laplace-P-spline approach.
#'
#' @return An \code{amlps} object has the following elements:
#'
#' \item{formula}{The formula of the additive model.}
#' \item{n}{Sample size.}
...
#'  terms.}
#' \item{ED}{The estimated degrees of freedom of the additive model.}
#' \item{sd.error}{The estimated standard deviation of the error.}
...
#' \item{Covmaximum}{The covariance matrix of the latent field evaluated at vmap.}
#' \item{latmaximum}{The latent field vector evaluated at vmap.}
